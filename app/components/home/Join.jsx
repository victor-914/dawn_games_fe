    ...
    <Box sx={{
      ...
      <Container maxWidth="lg">
        <Stack alignItems="center" spacing={4}>
          <Typography variant="h2" sx={{ fontFamily: 'Inter', fontWeight: 'bold', fontSize: { xs: 32, md: 48 }, color: '#FFFFFF' }}>
            Join the Movement
          </Typography>
          <Typography sx={{ fontFamily: 'Inter', fontSize: { xs: 16, md: 20 }, color: '#FFFFFF', maxWidth: 820, lineHeight: 1.6 }}>
          ...
          <Stack direction={{ xs: 'column', sm: 'row' }} spacing={3} mt={2} width={{ xs: '100%', sm: 'auto' }}>
            <Button endIcon={<ArrowForward sx={{ color: '#356EFF' }} />} sx={{
              bgcolor: '#FFFFFF', width: { xs: '100%', sm: 215.69 }, height: 56, borderRadius: '10px',
