    ...
    <Box sx={{
      ...
      <Container maxWidth="lg">
        ...
        <Stack direction="row" alignItems="center" spacing={2} sx={{ mb: 6 }}>
          <AutoAwesomeIcon sx={{ color: '#AC008C', width: 24, height: 24 }} />
          <Typography sx={{
            fontFamily: 'Inter',
            fontWeight: 'bold',
            fontSize: 36,
        ...
        <Box sx={{
          ...
          borderRadius: '24px',
          border: '1.6px solid rgba(255, 53, 218, 0.2)', // FF35DA 20%
          // APPLY PADDING HERE: This keeps content (including image) away from the edge
          p: { xs: 3, md: 6 }, 
          display: 'flex',
          ...
          <Box sx={{
            ...
            <Stack direction="row" alignItems="center" spacing={3} sx={{ mb: 4 }}>
              ...
              <Stack direction="row" spacing={1} alignItems="center">
                <AccessTimeIcon sx={{ color: '#99A1AF', fontSize: 18 }} />
                <Typography sx={{
                  fontFamily: 'Inter',
                  fontSize: 16,
                  color: '#99A1AF'
            ...
            <Typography variant="h3" sx={{
              ...
              Why 80% of African Sports Clubs <br/>
              Fail—And How Technology Can <br/> Fix It
            </Typography>
          ...
          {/* Right Image */}
          <Box sx={{
            // Sizing based on specs provided earlier: 501.6 x 501.6
            width: { xs: '100%', md: 501.6 },
            height: { xs: 300, md: 501.6 },
            backgroundImage: 'url(/blog-featured-image.png)',
            backgroundSize: 'cover',
            backgroundPosition: 'center',
            position: 'relative',
            // Image has its own radius now because it sits inside the padding
            borderRadius: '20px', 
            overflow: 'hidden',
            ...
            <Box sx={{ 
              position: 'absolute', 
              inset: 0, 
              background: 'linear-gradient(180deg, rgba(251, 44, 54, 0.2) 0%, rgba(255, 107, 53, 0.2) 100%)',
