...
const categories = { sports: { title: 'SPORTS MANAGEMENT', subtitle: 'Manage athletes and teams with professional tools', plans: [ { title: 'STARTER', price: '$200', frequency: '/mo', description: 'Up to 50 athletes', icon: <Bolt sx={{ fontSize: 28, color: '#FFFFFF' }} />, btnTxt: 'START 30-DAY FREE TRIAL', features: ['Athlete profile management', 'Training session scheduling', 'Communication portal', 'Automated invoicing', 'Basic performance reports'] }, { title: 'PROFESSIONAL', price: '$600', frequency: '/mo', description: 'Up to 150 athletes', saveText: 'Save $1,200 on annual plan', icon: <StarBorder sx={{ fontSize: 28, color: '#FFFFFF' }} />, btnTxt: 'START 30-DAY FREE TRIAL', popular: true, features: ['Multi-team management', 'AI video analysis (50 hrs)', 'Heat maps & movement', 'Physical metrics', 'Opponent scouting', 'Custom branded app'] }, { title: 'ENTERPRISE', price: 'Custom', frequency: '', description: 'Starting at $2,000/mo', icon: <DiamondOutlined sx={{ fontSize: 28, color: '#FFFFFF' }} />, btnTxt: 'CONTACT SALES', features: ['Unlimited athletes & teams', 'Unlimited video analysis', 'Real-time match analytics', 'Injury prevention AI', 'White-label mobile app', 'Dedicated account manager'] } ] }, esports: { title: 'ESPORTS PLATFORM', subtitle: 'Host tournaments and manage talent', plans: [ { title: 'COMMUNITY', price: '$150', frequency: '/mo', description: 'Host 10 tournaments/mo', icon: <SportsEsports sx={{ fontSize: 28, color: '#FFFFFF' }} />, btnTxt: 'START 30-DAY FREE TRIAL', features: ['Up to 80 participants', 'Basic bracket management', 'Automated registration', 'Prize pool tracking', 'Player profiles & stats'] }, { title: 'COMPETITOR', price: '$400', frequency: '/mo', description: 'Unlimited tournaments', saveText: 'Most popular for agencies', icon: <EmojiEvents sx={{ fontSize: 28, color: '#FFFFFF' }} />, btnTxt: 'START 14-DAY FREE TRIAL', popular: true, features: ['Up to 500 participants', 'Advanced bracket formats', '10+ games support', 'Advanced ELO ranking', 'Contract management', 'Sponsorship tracking'] }, { title: 'PRO LEAGUE', price: 'Custom', frequency: '', description: 'Starting at $1,000/mo', icon: <DiamondOutlined sx={{ fontSize: 28, color: '#FFFFFF' }} />, btnTxt: 'SCHEDULE CONSULTATION', features: ['5,000+ participants', 'League season management', 'Franchise management', 'White-label platform', 'Anti-cheat integration', 'AI player scouting'] } ] }, gamedev: { title: 'GAME DEVELOPMENT', subtitle: 'Build and launch games with African-focused tools', plans: [ { title: 'INDIE', price: '$300', frequency: '/mo', description: '1 active game project', icon: <Code sx={{ fontSize: 28, color: '#FFFFFF' }} />, btnTxt: 'CONTACT SALES', features: ['Dev templates', 'African asset library', 'Backend infrastructure', 'Cross-platform build', '100GB storage', 'Up to 10,000 MAU'] }, { title: 'STUDIO', price: '$800', frequency: '/mo', description: '3 active game projects', saveText: 'Most Popular', icon: <StarBorder sx={{ fontSize: 28, color: '#FFFFFF' }} />, btnTxt: 'CONTACT SALES', popular: true, features: ['500GB storage', '100k MAU per game', 'Multiplayer networking', 'Console deployment', 'CI/CD pipeline', 'Payment processing'] }, { title: 'PUBLISHER', price: 'Custom', frequency: '', description: 'Starting at $2,000/mo', icon: <DiamondOutlined sx={{ fontSize: 28, color: '#FFFFFF' }} />, btnTxt: 'SCHEDULE CONSULTATION', features: ['Unlimited projects', 'Unlimited MAU', '2TB+ storage', 'Dedicated servers', 'Global distribution', 'PR & media outreach'] } ] } }
