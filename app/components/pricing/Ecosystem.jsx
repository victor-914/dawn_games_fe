...
const categories = { sports: { title: 'SPORTS MANAGEMENT', subtitle: 'Manage athletes and teams with professional tools', plans: [ { title: 'STARTER', price: '$200', frequency: '/mo', description: 'Up to 50 athletes', icon: <Bolt sx={{ fontSize: 28, color: '#FFFFFF' }} />, btnTxt: 'START 30-DAY FREE TRIAL', features: ['Athlete profile management (50 max)', 'Training session scheduling', 'Parent/athlete communication portal', 'Automated invoicing & billing', 'Basic performance reports', 'Attendance tracking', 'Email support (48h response)'], tagline: 'Best for youth academies & school programs' }, { title: 'PROFESSIONAL', price: '$600', frequency: '/mo', description: 'Up to 150 athletes', saveText: 'Save $1,200 on annual plan', icon: <StarBorder sx={{ fontSize: 28, color: '#FFFFFF' }} />, btnTxt: 'START 30-DAY FREE TRIAL', popular: true, features: ['Everything in Starter, plus:', 'Multi-team management', 'AI video analysis (50 hrs/mo)', 'Heat maps & movement patterns', 'Physical performance metrics', 'Opponent scouting reports', 'Cognitive training (5 athletes)', 'Custom branded mobile app', 'Priority support (24h response)'], tagline: 'Best for professional clubs & academies' }, { title: 'ENTERPRISE', price: 'Custom', frequency: '', description: 'Starting at $2,000/mo', icon: <DiamondOutlined sx={{ fontSize: 28, color: '#FFFFFF' }} />, btnTxt: 'CONTACT SALES', features: ['Everything in Professional, plus:', 'Unlimited athletes & teams', 'Unlimited video analysis', 'Real-time match analytics', 'Injury prevention AI alerts', 'Custom ML models', 'White-label mobile app', 'Dedicated account manager', '24/7 phone + email support'], tagline: 'Best for premier clubs & federations' } ] }, esports: { title: 'ESPORTS PLATFORM', subtitle: 'Host tournaments and manage talent', plans: [ { title: 'COMMUNITY', price: '$150', frequency: '/mo', description: 'Host 10 tournaments/mo', icon: <SportsEsports sx={{ fontSize: 28, color: '#FFFFFF' }} />, btnTxt: 'START 30-DAY FREE TRIAL', features: ['Up to 80 participants', 'Basic bracket management', 'Automated registration', 'Prize pool tracking', 'Player profiles & stats'], tagline: 'Best for community organizers' }, { title: 'COMPETITOR', price: '$400', frequency: '/mo', description: 'Unlimited tournaments', saveText: 'Most popular for agencies', icon: <EmojiEvents sx={{ fontSize: 28, color: '#FFFFFF' }} />, btnTxt: 'START 14-DAY FREE TRIAL', popular: true, features: ['Up to 500 participants', 'Advanced bracket formats', '10+ games support', 'Advanced ELO ranking', 'Contract management', 'Sponsorship tracking'], tagline: 'Best for esports agencies' }, { title: 'PRO LEAGUE', price: 'Custom', frequency: '', description: 'Starting at $1,000/mo', icon: <DiamondOutlined sx={{ fontSize: 28, color: '#FFFFFF' }} />, btnTxt: 'SCHEDULE CONSULTATION', features: ['5,000+ participants', 'League season management', 'Franchise management', 'White-label platform', 'Anti-cheat integration', 'AI player scouting'], tagline: 'Best for pro leagues' } ] }, gamedev: { title: 'GAME DEVELOPMENT', subtitle: 'Build and launch games with African-focused tools', plans: [ { title: 'INDIE', price: '$300', frequency: '/mo', description: 'For solo developers and small teams (1-3 people)', icon: <Code sx={{ fontSize: 28, color: '#FFFFFF' }} />, btnTxt: 'CONTACT SALES', features: ['Game development templates', 'African-focused asset library', 'Backend infrastructure', '1 active game project', 'Cross-platform build support', '100GB storage', 'Up to 10,000 MAU', 'In-app purchase integration', 'Player analytics', 'App store listing assistance'], tagline: 'For solo developers' }, { title: 'STUDIO', price: '$800', frequency: '/mo', description: 'For professional studios (4-10 people)', saveText: 'Most Popular', icon: <StarBorder sx={{ fontSize: 28, color: '#FFFFFF' }} />, btnTxt: 'CONTACT SALES', popular: true, features: ['Everything in Indie, plus:', 'Up to 3 active game projects', '500GB storage', 'Up to 100,000 MAU per game', 'Multiplayer networking', 'Console deployment support', 'CI/CD pipeline', 'Optimized payment processing', 'Churn prediction AI', 'ASO service', 'Influencer campaign management', 'Publisher introduction program'], tagline: 'For professional studios' }, { title: 'PUBLISHER', price: 'Custom', frequency: '', description: 'starting at $2,000/month', icon: <DiamondOutlined sx={{ fontSize: 28, color: '#FFFFFF' }} />, btnTxt: 'SCHEDULE CONSULTATION', features: ['Everything in Studio, plus:', 'Unlimited active game projects', 'Unlimited MAU across all games', '2TB+ storage (expandable)', 'Dedicated server infrastructure', 'Full console support', 'Global distribution strategy', 'PR and media outreach', 'Localization to 20+ languages', 'Direct partnerships (major studios)', 'Investment facilitation', '24/7 priority support + producer'], tagline: 'For established studios & publishers' } ] } }
